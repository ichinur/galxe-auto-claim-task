...
- Press F12 or Ctrl + Shift + I to open Developer Tools in your browser.
- Go to the Console tab.
## Step 2: Allow Pasting (If Blocked)
```
allow pasting
```
- Usually, pasting is allowed by default. If not, check for any browser extensions or security settings blocking it.
...
function _0x132c() {
  var e = [
    ...
    '140327JMWYdv',
    'querySelector',
    'Galxe Auto Complete tasks – ICHIBOT\n\n https://t.me/litbrother',
    '2666664nNzmZe',
    'querySelectorAll',
...
processElements();
```
- Paste it into the console by pressing Ctrl + V.
